    ...
    <div class="content">
        <div class="description">
            ...
            <div class="title-section">
                <h1>{appName}</h1>
                <p class="availability">This app will be available soon</p>
        ...
        <div class="how-it-works">
            <div class="how-it-works-content">
                ...
                <h2>How it works</h2>
                <p>
                    Make sure your mobile device and TV are on the same Wi-Fi network. Launch the <span class="highlight">{appName}</span> app and tap the cast icon 
